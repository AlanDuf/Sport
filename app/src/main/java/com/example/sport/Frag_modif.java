...
public class Frag_modif extends Fragment implements View.OnClickListener {


    public Frag_modif() {
        super(R.layout.frag_modif);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btnadd:
                ((Activity2)getActivity()).updateListe(exo);
                break;
            case R.id.btnDel:
                ((Activity2)getActivity()).deleteExo(editText.getText().toString());
        }
